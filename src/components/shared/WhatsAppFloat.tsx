...
export default function WhatsAppFloat() {
  ...
  const phone = normalizePhoneForLink(contactPhone);
  const message = encodeURIComponent("Salam! Sifariş vermək istəyirəm.");
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 transition-shadow hover:shadow-xl hover:shadow-[#25D366]/40"
    >
