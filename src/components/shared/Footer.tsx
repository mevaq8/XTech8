...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0F172A]">
      <div className="h-12 bg-gradient-to-b from-[#F8FAFC] to-[#0F172A]" />

      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 pt-8 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h4 className="font-sora font-semibold text-white text-sm mb-3">Kateqoriyalar</h4>
            ...
            <div>
              <h4 className="font-sora font-semibold text-white text-sm mb-3">Səhifələr</h4>
              <ul className="space-y-2">
                <li>
          ...
          <div>
            <h4 className="font-sora font-semibold text-white text-sm mb-3">Əlaqə</h4>
            <ul className="space-y-2">
            ...
            <div className="mt-4">
              <p className="text-xs font-inter text-slate-500 mb-2">Bizi izləyin</p>
